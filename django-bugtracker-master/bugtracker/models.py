...
class Ticket(models.Model):
    ...
    assigned_to = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='+', on_delete=models.CASCADE)
...
class TicketUpdate(models.Model):
    ...
    attachment = models.FileField(upload_to='bugtracker', blank=True, null=True)
    updated_time = models.DateTimeField(auto_now=True)
    updated_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='+', on_delete=models.CASCADE)
